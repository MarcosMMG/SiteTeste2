---
name: seo-tecnico
description: SEO técnico/engenharia — audit e implementação de crawlability, indexação, canonical, structured data (JSON-LD/schema), Core Web Vitals (LCP/INP/CLS), sitemap/robots e keyword→URL. Use pra deixar o site tecnicamente correto e rankeável (complementa o /seo de estratégia). Trigger: "seo técnico", "schema", "core web vitals", "sitemap", "robots", "auditoria técnica do site".
metadata:
  origin: ECC
---
