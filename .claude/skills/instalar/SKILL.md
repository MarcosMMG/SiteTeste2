...
name: instalar
description: >
  Instala o JemacPRO no negócio do usuário. Entrevista sobre empresa, tom de voz,
  ...
  pedir explicitamente "rodar /instalar", "instalar o JemacPRO", "primeiro setup".
---

# /instalar — Instalação inicial do JemacPRO
...
Conferir o nome da pasta atual (`basename "$(pwd)"`). Se for `jemacpro`, `JemacPRO`, `JemacPRO-main`, `jemacpro-main` ou variação genérica:

> "Notei que a pasta atual ainda tem nome genérico ('<nome-atual>'). O ideal é a pasta ter o nome do seu negócio, não 'JemacPRO'. Quando terminarmos o setup, te lembro de renomear (é rápido — fechar VS Code, renomear a pasta no Finder/Explorer, abrir de novo). Bora seguir?"
...
> "Pronto. O JemacPRO já te conhece.
>
